...
class ExpenseAdapter(private var dataList: MutableList<Data>,private val itemClickListener: ExpenseItemClickListener) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    inner class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView),View.OnClickListener {
        private val mType: TextView = itemView.findViewById(R.id.type_txt_expense)
        private val mNote: TextView = itemView.findViewById(R.id.note_txt_expense)
        private val mDate: TextView = itemView.findViewById(R.id.date_txt_expense)
        private val mAmount: TextView = itemView.findViewById(R.id.ammount_txt_expense)
private var dataId:String=""
    ...
    fun setData(newData: List<Data>) {
        dataList.clear()
        dataList.addAll(newData) // Add new data
