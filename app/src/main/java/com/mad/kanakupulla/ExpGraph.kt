...
class ExpGraph : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_exp_graph, container, false)
    ...
    private fun fetchIncomeData() {
        ...
        val databaseRef = FirebaseDatabase.getInstance().getReference("ExpenseData").child(year).child(yearMonth).child(uid)
    ...
    private fun updateLineChart(entries: List<Entry>) {
        ...
        description.text = "Expense Over Time"
